...
const Sidebar = ({ defualtState = true, toggleIndent = null }) => {
    ...
    return (<>
        ...
        <div className={`fixed h-screen xl:top-16 w-72 md:w-80 border-r-2 border-gray-200 bg-white flex flex-col ${enableAnim ? "transition-left duration-1000" : "duration-[0ms]"} duration-1000 ease-out z-20 ${showSidebar ? "left-0" : "-left-72 md:-left-80"}`}>
            <div className="h-6" />
            ...
            <div className={`invisible xl:visible absolute top-[calc(30vh)] left-80 w-20 h-20 overflow-hidden`}>
                {toggleIndent !== null &&
            ...
            <div className={`
                ...
                absolute top-[calc(30vh)] left-72 md:left-80 
                w-20 h-20 overflow-hidden`}
            >
                {toggleIndent !== null &&

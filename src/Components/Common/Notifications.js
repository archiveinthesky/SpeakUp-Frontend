...
const NotificationButton = () => {
    ...
    return (
        <Menu as="div" className="relative inline-block text-left z-10">
            <div className='h-8'>
                <Menu.Button className="relative inline-flex justify-center items-center w-8 h-8 shadow-sm text-sm overflow-hidden text-white hover:text-gray-100 focus:text-gray-100" onClick={readNotifications}>
                    <BellIcon />

...
const SubmitComment = ({ onSideProp, closeSubmitComment, userComments, setUserComments }) => {
    ...
    return (
        <div className="w-screen h-screen fixed top-0 left-0 grid align-middle">
                ...
                <div className="w-10/12 mx-auto mb-4 flex justify-end">
                    ...
                    <button className="w-24 h-10 rounded-2xl bg-green-400 bg-opacity-50 flex">
                        <div className="m-auto">
                            <h2 className={"text-2xl text-green-600 text-center"} onClick={postComment}>發送</h2>
                        </div>
                    </button>
                </div>
            </div>

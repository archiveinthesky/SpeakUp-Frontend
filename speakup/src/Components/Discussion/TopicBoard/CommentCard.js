            ...
            <div className="w-10/12 mx-auto flex mt-2 mb-2">
                <div className="flex min-w-max border-2 border-black rounded-3xl">
                    <div className="ml-2 my-1">
                        ...
                        <span className="align-middle"><p className="inline text-lg mr-2">{cmtdata.cmtSupport}</p></span>
                    </div>
                    <div className="ml-2 my-1">
                        ...
                        <span className="align-middle"><p className="inline text-lg mr-2">{cmtdata.cmtLikes}</p></span>
                    </div>
                    <div className="mx-2 my-1">
                        ...
                        <span className="align-middle"><p className="inline text-lg mr-2">{cmtdata.cmtDislikes}</p></span>
                    </div>
                </div>
